class ZMC_CL_SAP04_NEW_ENTRY_2_YEDEK definition
  public
  final
  create public .
...
public section.
  ...
  data MT_STRAVELAG type ZMC_TT_STRAVELAG_2 .
...
CLASS ZMC_CL_SAP04_NEW_ENTRY_2_YEDEK IMPLEMENTATION.
...
*               RECEIVING rv_url  = ls_stravelag-url ).
  ...
  METHOD PREP_DATA.
    ...
    SELECT * FROM zmc_sap04_strav
      INTO CORRESPONDING FIELDS OF TABLE mt_stravelag.
  ...
  METHOD PREP_LAYOUT.
    ...
    ms_layout-colwidth_optimize = iv_colwidth_optimize.
